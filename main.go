...
func main() {
	...
	for remainingTickets > 0 {
		...
		isValidName, isValidEmail, isValidUserTickets := validateUserInput(firstName, lastName, emailAddress, userTickets)
...
func saveBooking(userTickets uint, firstName string, lastName string, emailAddress string) (uint, []string) {
